...
function NzTimelineComponent_ng_template_5_Conditional_0_ng_container_3_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementContainerStart(0);
    ɵɵtext(1);
    ɵɵtemplate(2, NzTimelineComponent_ng_template_5_Conditional_0_ng_container_3_Conditional_2_Template, 1, 0, "nz-icon", 8);
    ɵɵelementContainerEnd();
  }
  if (rf & 2) {
...
var NzTimelineComponent = class _NzTimelineComponent {
  ...
  static {
    this.ɵcmp = ɵɵdefineComponent({
      ...
      exportAs: ["nzTimeline"],
      features: [ɵɵProvidersFeature([TimelineService]), ɵɵInputTransformsFeature, ɵɵNgOnChangesFeature],
      ngContentSelectors: _c1,
      decls: 8,
      vars: 14,
