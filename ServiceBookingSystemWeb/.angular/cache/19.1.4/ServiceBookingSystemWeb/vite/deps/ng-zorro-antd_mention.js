...
var NzMentionTriggerDirective = class _NzMentionTriggerDirective {
  ...
  setupEventListener(eventName, eventEmitter) {
    fromEventOutsideAngular(this.el.nativeElement, eventName).pipe(takeUntil(this.destroy$)).subscribe((event) => {
...
var NzMentionComponent = class _NzMentionComponent {
  ...
  static {
    this.ɵcmp = ɵɵdefineComponent({
      ...
      dependencies: [NgTemplateOutlet, NzIconModule, NzIconDirective, NzEmptyModule, NzEmbedEmptyComponent, NzFormItemFeedbackIconComponent],
      encapsulation: 2,
      changeDetection: 0
    });
  }
