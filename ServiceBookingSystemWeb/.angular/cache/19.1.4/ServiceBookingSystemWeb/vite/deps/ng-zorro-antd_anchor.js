import {
  NzAffixComponent,
  NzAffixModule
} from "./chunk-EQAJC6RQ.js";
import "./chunk-T4B7TTL2.js";
import {
  NzScrollService
...
var NzAnchorComponent = (() => {
  ...
  return class NzAnchorComponent2 {
    ...
    constructor(nzConfigService, scrollSrv, cdr, platform, renderer) {
      ...
      this.nzOffsetTop = (__runInitializers(this, _nzBounds_extraInitializers), __runInitializers(this, _nzOffsetTop_initializers, void 0));
      this.nzTargetOffset = (__runInitializers(this, _nzOffsetTop_extraInitializers), __runInitializers(this, _nzTargetOffset_initializers, void 0));
    ...
    static {
      this.ɵfac = function NzAnchorComponent_Factory(__ngFactoryType__) {
        return new (__ngFactoryType__ || NzAnchorComponent2)(ɵɵdirectiveInject(NzConfigService), ɵɵdirectiveInject(NzScrollService), ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(Platform), ɵɵdirectiveInject(Renderer2));
      };
    }
    static {
      this.ɵcmp = ɵɵdefineComponent({
        ...
        template: function NzAnchorComponent_Template(rf, ctx) {
          if (rf & 1) {
            ɵɵprojectionDef();
            ɵɵtemplate(0, NzAnchorComponent_Conditional_0_Template, 2, 3, "nz-affix", 2)(1, NzAnchorComponent_Conditional_1_Template, 1, 1, null, 3)(2, NzAnchorComponent_ng_template_2_Template, 6, 10, "ng-template", null, 0, ɵɵtemplateRefExtractor);
          }
          if (rf & 2) {
