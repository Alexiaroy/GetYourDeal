...
var NzTreeNodeOptionComponent = class _NzTreeNodeOptionComponent {
  ...
  ngOnInit() {
    fromEventOutsideAngular(this.host.nativeElement, "click").pipe(filter(() => !this.nzDisabled && this.nzClick.observers.length > 0), takeUntil(this.destroy$)).subscribe((event) => {
