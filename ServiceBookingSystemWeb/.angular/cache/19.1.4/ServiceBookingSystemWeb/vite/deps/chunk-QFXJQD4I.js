...
function NzTreeNodeSwitcherComponent_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵtemplate(0, NzTreeNodeSwitcherComponent_Conditional_0_Conditional_0_Template, 1, 5, "ng-container")(1, NzTreeNodeSwitcherComponent_Conditional_0_Conditional_1_Template, 1, 1, "nz-icon", 0);
  }
  if (rf & 2) {
...
function NzTreeNodeSwitcherComponent_Conditional_1_Conditional_0_ng_container_0_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementContainerStart(0);
    ɵɵtemplate(1, NzTreeNodeSwitcherComponent_Conditional_1_Conditional_0_ng_container_0_Conditional_1_Template, 1, 1, "span", 3)(2, NzTreeNodeSwitcherComponent_Conditional_1_Conditional_0_ng_container_0_Conditional_2_Template, 1, 0, "nz-icon", 4);
    ɵɵelementContainerEnd();
  }
  if (rf & 2) {
    const ctx_r0 = ɵɵnextContext(3);
...
function NzTreeNodeSwitcherComponent_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵtemplate(0, NzTreeNodeSwitcherComponent_Conditional_1_Conditional_0_Template, 1, 5, "ng-container")(1, NzTreeNodeSwitcherComponent_Conditional_1_Conditional_1_Template, 1, 1, "nz-icon", 0);
  }
  if (rf & 2) {
    const ctx_r0 = ɵɵnextContext();
    ɵɵconditional(!ctx_r0.isLoading ? 0 : 1);
...
function NzTreeNodeTitleComponent_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵtemplate(0, NzTreeNodeTitleComponent_Conditional_1_Conditional_0_Template, 3, 19, "span", 2);
    ɵɵelement(1, "span", 3);
...
var NzTreeNodeSwitcherComponent = class _NzTreeNodeSwitcherComponent {
  ...
  static {
    this.ɵcmp = ɵɵdefineComponent({
      ...
      decls: 2,
      vars: 2,
      consts: [["nzType", "loading", 1, "ant-tree-switcher-loading-icon", 3, "nzSpin"], [4, "nzStringTemplateOutlet", "nzStringTemplateOutletContext"], ["nz-icon", "", "nzType", "caret-down"], ["nz-icon", "", 1, "ant-tree-switcher-line-icon", 3, "nzType"], ["nzType", "file", 1, "ant-tree-switcher-line-icon"]],
  ...
  static {
    this.ɵcmp = ɵɵdefineComponent({
      ...
      template: function NzTreeNodeTitleComponent_Template(rf, ctx) {
        if (rf & 1) {
          ɵɵtemplate(0, NzTreeNodeTitleComponent_ng_template_0_Template, 0, 0, "ng-template", 0)(1, NzTreeNodeTitleComponent_Conditional_1_Template, 3, 7)(2, NzTreeNodeTitleComponent_Conditional_2_Template, 1, 2, "nz-tree-drop-indicator", 1);
        }
        if (rf & 2) {
...
var NzTreeNodeBuiltinComponent = class _NzTreeNodeBuiltinComponent {
  ...
  handDragEvent() {
    if (this.nzDraggable) {
      ...
      fromEventOutsideAngular(nativeElement, "dragstart").pipe(takeUntil(this.destroy$)).subscribe((e) => this.handleDragStart(e));
      fromEventOutsideAngular(nativeElement, "dragenter").pipe(takeUntil(this.destroy$)).subscribe((e) => this.handleDragEnter(e));
      fromEventOutsideAngular(nativeElement, "dragover").pipe(takeUntil(this.destroy$)).subscribe((e) => this.handleDragOver(e));
      fromEventOutsideAngular(nativeElement, "dragleave").pipe(takeUntil(this.destroy$)).subscribe((e) => this.handleDragLeave(e));
      fromEventOutsideAngular(nativeElement, "drop").pipe(takeUntil(this.destroy$)).subscribe((e) => this.handleDragDrop(e));
      fromEventOutsideAngular(nativeElement, "dragend").pipe(takeUntil(this.destroy$)).subscribe((e) => this.handleDragEnd(e));
    } else {
  ...
  return class NzTreeComponent2 extends _classSuper {
    ...
    static {
      this.ɵfac = function NzTreeComponent_Factory(__ngFactoryType__) {
        return new (__ngFactoryType__ || NzTreeComponent2)(ɵɵdirectiveInject(NzTreeBaseService), ɵɵdirectiveInject(NzConfigService), ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(Directionality));
      };
    }
    static {
      this.ɵcmp = ɵɵdefineComponent({
        ...
        template: function NzTreeComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            ɵɵtemplate(6, NzTreeComponent_Conditional_6_Template, 2, 11, "cdk-virtual-scroll-viewport", 5)(7, NzTreeComponent_Conditional_7_Template, 3, 7, "div", 6);
            ɵɵelementEnd();
...
//# sourceMappingURL=chunk-QFXJQD4I.js.map
